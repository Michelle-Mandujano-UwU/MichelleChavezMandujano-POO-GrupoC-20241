...
public class Libreria {
   ...
   public Libreria() {
       Asistente asistente = new Asistente("Dulce", "Mandujano", "656556888", 1000, "hdhjsd5454", "dulce123", "dulce1","21/12/2000");
        Gerente gerente = new Gerente("Michelle", "Chávez", "555456511321", 80000, "hhdbshdhv", "gdhsgdhj", "Michelleuwu_", "21Diciembre","24/11/20003");
    ...
    public static ArrayList<String> obtenerDatosComun(Rol rol) {
        ...
        String fechaIngresoString = scanner.nextLine();
        LocalDate fechaIngreso = LocalDate.parse(fechaIngresoString, DateTimeFormatter.ISO_DATE);

        datosComun.addAll(Arrays.asList(nombre, apellido, telefono, nombreUsuario, contraseña, fechaIngresoString)); //te agrega todos estos datos de un jalon
        return datosComun;
    }
