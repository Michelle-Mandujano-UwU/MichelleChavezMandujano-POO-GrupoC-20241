...
public class LibroTerror extends Libro {
    ...
    public static void registrarLibro() {
        ...
        String precio = datosComun.get(4);
        String stock = datosComun.get(5);
        ...
        LibroTerror libroTerror = new LibroTerror(titulo, autor, editorial, String.valueOf(fechaPublicacion), Double.parseDouble(precio), Integer.parseInt(stock), subgeneroInput);
