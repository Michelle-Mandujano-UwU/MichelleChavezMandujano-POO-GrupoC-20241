...
public class Asistente extends Usuario implements EmpleadoUtils {
    ...
    public Asistente(String nombre, String apellido, String telefono, double sueldo, String rfc, String nombreUsuario, String contrasena, String fechaIngresoString) {
        super(nombre, apellido, telefono, Rol.ASISTENTE, nombreUsuario, contrasena,fechaIngresoString);
    ...
    public static void registrarAsistente() {
        ...
        Asistente asistente = new Asistente(nombre, apellido, telefono, sueldo, rfc.toUpperCase(), nombreUsuario, contraseña,fechaIngresoString);
