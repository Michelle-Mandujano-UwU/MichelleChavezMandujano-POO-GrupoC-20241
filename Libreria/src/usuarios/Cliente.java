...
public class Cliente extends Usuario {
    ...
    public Cliente (String nombre, String apellido, String telefono, String nombreUsuario, String contrasena, String fechaIngresoString) {
        super(nombre, apellido, telefono, Rol.CLIENTE, nombreUsuario, contrasena, fechaIngresoString);
    ...
    public static void registrarCliente() {
        ...
        Cliente cliente = new Cliente(nombre, apellido, telefono, nombreUsuario, contraseña, fechaIngresoString);
