...
public class Libreria {
    ...
    public Libreria() {
        Gerente gerente = new Gerente("Michelle", "Chavez", "4171161560", 80000, "hdshjd", "GFHBGFD", "michelle21", "21diciembre", String.valueOf(LocalDate.of(2000, 10, 28)));
        Asistente asistente = new Asistente("Diana", "Campos", "4433210990", 15000, "DL1234123", "diana12", "michelle21", String.valueOf(LocalDate.of(1982, 04, 30)));
        inicializarhashmap();
