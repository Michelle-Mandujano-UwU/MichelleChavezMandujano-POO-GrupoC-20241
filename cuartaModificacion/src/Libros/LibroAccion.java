...
public class LibroAccion extends Libro {
    ...
    public LibroAccion(String nombre, String autor, String editorial, String fechaPublicacion, double precio, int stock, Genero gen) {
        super(nombre, autor, editorial, fechaPublicacion, precio, stock, gen);
    }
    ...
    public String getData() {
        return String.format("%s", super.getData() + "Clasificación: " + clasificacion);
    }
    ...
    public static void registrarLibroAccion() {
        ...
        String precio = datos.get(2);
        String fechaPublicacion = datos.get(3);
        String editorial = datos.get(4);
